...
public class Q03 {
    ...
    public void test() {
        ...
        // Click on 'Form'
        driver.findElement(By.linkText("Form")).click();        // or a[.='Form']  or //a[@href='/Students/Form']
        ...
        // Check the Marital Status: Married
        driver.findElement(By.xpath("//input[@type='radio'][1]")).click();      ////*[@name='optradio'][1]"
        System.out.println("radio element");
        ...
        select.selectByVisibleText("Canada");       //select.selectByIndex(13); index starter from 0 here
...
//        driver.findElement(By.linkText("Submit")).click();
        ...
        submitButton.submit();          //or submitButton.sendKeys(Keys.ENTER);
