...
public class Q11_Select_Faker extends TestBase {
    ...
    public void register() throws InterruptedException {
        ...
        WebElement register = driver.findElement(By.xpath("//span[text()='Sign up']"));
        register.click();

        WebElement emailInstead = driver.findElement(By.xpath("//span[text()='Sign up with a phone number or email address']"));

        clickByJS(emailInstead);
