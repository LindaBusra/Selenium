...
//        1. Creating Fluent Wait Object
        Wait<WebDriver> wait = new FluentWait<>(driver)    //need to be import from java util
        ...
        //you can not ignore an exception with explicit wait
